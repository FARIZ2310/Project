...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2023 at 11:42 AM
...
CREATE TABLE `tb_inovasi_skpd` (
  ...
  `jenis_inovasi` enum('-','TTG (Teknologi Tepat Guna)') NOT NULL,
...
INSERT INTO `tb_inovasi_skpd` (`id_inovasi_skpd`, `judul_inovasi`, `jenis_inovasi`, `tahun_inovasi`, `latar_belakang`, `tujuan`, `manfaat`, `status`, `progress`, `id_skpd`) VALUES
(2, '1', '-', '2', 'w3', 'w4', 'w5', 'Tidak Terlaksana', 'Ekspose Awal', 1),
(3, 'ed', 'TTG (Teknologi Tepat Guna)', 'it', '1', '2', '3', 'Tidak Terlaksana', 'Ekspose Awal', 1);
...
INSERT INTO `tb_skpd` (`id_skpd`, `nama_skpd`, `alamat`, `email`, `kontak`, `website`) VALUES
(1, 'Google', 'Jl. Intansari', 'google@google.com', '082121212121', 'https://www.google.com');
...
--
ALTER TABLE `tb_inovasi_skpd`
  MODIFY `id_inovasi_skpd` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
