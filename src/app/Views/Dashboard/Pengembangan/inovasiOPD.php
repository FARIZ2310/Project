...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">Pengembangan /</span> Inovasi OPD
            </h4>
            
            <div class="card">
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center">
                        <h5 class="card-title mb-0">Inovasi OPD</h5>
                    </div>
            ...
            <div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    <form action="<?= base_url('Pengembangan/InovasiOPD/add') ?>" method="post" id="formTambah">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalTambahTitle">Tambah Inovasi OPD</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="row mb-3">
                                    <label for="judul_inovasi" class="form-label">Judul Inovasi OPD</label>
                                    <textarea id="judul_inovasi" name="judul_inovasi" class="form-control" placeholder="Judul Inovasi OPD"></textarea>
                                ...
                                <div class="row mb-3">
                                    <label for="latar_belakang" class="form-label">Latar Belakang Inovasi OPD</label>
                                    <textarea id="latar_belakang" name="latar_belakang" class="form-control" placeholder="Latar Belakang Inovasi OPD"></textarea>
                                    <span class="text-danger error-text latar_belakang_error"></span>
                                </div>
                                <div class="row mb-3">
                                    <label for="tujuan" class="form-label">Tujuan Inovasi OPD</label>
                                    <textarea id="tujuan" name="tujuan" class="form-control" placeholder="Tujuan Inovasi OPD"></textarea>
                                    <span class="text-danger error-text tujuan_error"></span>
                                </div>
                                <div class="row mb-3">
                                    <label for="manfaat" class="form-label">Manfaat Inovasi OPD</label>
                                    <textarea id="manfaat" name="manfaat" class="form-control" placeholder="Manfaat Inovasi OPD"></textarea>
                                    <span class="text-danger error-text manfaat_error"></span>
                                </div>
                                <div class="row mb-3">
                                    <label for="status" class="form-label">Status</label>
                                    <select id="status" name="status" class="form-select">
                                        <option value="">Pilih Status Inovasi OPD</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <select id="progress" name="progress" class="form-select">
                                        <option value="">Pilih Progress Inovasi OPD</option>
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('Pengembangan/InovasiOPD/update') ?>" method="post" id="formEdit">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalEditTitle">Edit Inovasi OPD</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="row mb-3">
                                    <label for="judul_inovasi_edit" class="form-label">Judul Inovasi OPD</label>
                                    <textarea id="judul_inovasi_edit" name="judul_inovasi_edit" class="form-control" placeholder="Judul Inovasi OPD"></textarea>
                                ...
                                <div class="row mb-3">
                                    <label for="latar_belakang_edit" class="form-label">Latar Belakang Inovasi OPD</label>
                                    <textarea id="latar_belakang_edit" name="latar_belakang_edit" class="form-control" placeholder="Latar Belakang Inovasi OPD"></textarea>
                                    <span class="text-danger error-text latar_belakang_edit_error"></span>
                                </div>
                                <div class="row mb-3">
                                    <label for="tujuan_edit" class="form-label">Tujuan Inovasi OPD</label>
                                    <textarea id="tujuan_edit" name="tujuan_edit" class="form-control" placeholder="Tujuan Inovasi OPD"></textarea>
                                    <span class="text-danger error-text tujuan_edit_error"></span>
                                </div>
                                <div class="row mb-3">
                                    <label for="manfaat_edit" class="form-label">Manfaat Inovasi OPD</label>
                                    <textarea id="manfaat_edit" name="manfaat_edit" class="form-control" placeholder="Manfaat Inovasi OPD"></textarea>
...
<script>
    ...
    $(document).on('click', '#btn_edit', function(e) {
		...
		id = $(this).data('kode'); 
		$.ajax({
			url: '<?php echo base_url("Pengembangan/InovasiOPD/get") ?>',
			type: 'POST',
			dataType: 'JSON',
			data: {
				id: id,
		...
		.done(function(data) {
			if (data) {
                $('#id_edit').val(data.id_inovasi_opd);
    ...
    function hapus(kdKode) {
        ...
        .then((willDelete) => {
            if (willDelete) { 
			    $.ajax({
				    url: "<?php echo base_url('Pengembangan/InovasiOPD/delete') ?>",
				    data: {
					    id: id,
				    },
				    type: 'POST',
